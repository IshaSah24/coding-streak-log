...
Before writing any actual code, I took the time to **polish my backend fundamentals** from scratch. I revisited and refined my **JavaScript and React skills**, because I knew that once I started, it wasn’t going to be about just a few components or simple pages. It would be about building something real — with structure, flow, and scalability.
